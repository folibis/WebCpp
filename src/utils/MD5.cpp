...
void MD5::MD5Transform(uint32_t state[], const uint8_t block[64])
{
...
void MD5::MD5Update(const uint8_t *input, size_t inputLen)
{
...
void MD5::MD5Final(uint8_t digest[16])
{
    ...
    index = static_cast<size_t>((context.count[0] >> 3) & 0x3f);
